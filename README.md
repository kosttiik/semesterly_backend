...
- Административная панель для обновления и очистки базы данных расписания
...
2. Клонируйте фронтенд-репозиторий в соседнюю папку:
   ```
   git clone https://github.com/kosttiik/semesterly_frontend ../semesterly_frontend
   ```
